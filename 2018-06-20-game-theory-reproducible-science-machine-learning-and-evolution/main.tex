...
\end{frame}
    ...
    \begin{frame}
        ...
        % The strategies that win are of a number of specific forms: this is a
        % lookerup.
    \end{frame}
    ...
    \begin{frame}
        \begin{center}
            ...
            \scalebox{.8}{
                \input{\mlresearchfolder/assets/gambler.tex}
            }
        \end{center}
    \end{frame}
...
\end{frame}
    ...
    \begin{frame}
        \begin{center}
            \scalebox{.6}{\input{\moranresearchfolder/tex/moran_process.tex}}
        \end{center}
        % We are now going to discuss something ever so slightly different.
        % What we have here is a particular game theoretic process called a
        % Moran process. In this case we don't just look at everyones score but
        % at how a population evolves based on everyones score. Think of it as a
        % way of modelling how people use operating systems. The use of a
        % particular OS is better if there are more people you know who use it.
        % [EXPLAIN THE PROCESS]
    \end{frame}
