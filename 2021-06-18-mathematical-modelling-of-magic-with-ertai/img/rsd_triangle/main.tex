...
\draw[draw=none] (-4.5, -4.5) rectangle (4.5, 4.5);

\node[circle, draw=black, minimum size=2.5cm] (M) at (0, 3.8) {Modularity};
\node[circle, draw=black, minimum size=2.5cm] (D) at (-3.398075, -1.5) {Documentation};
\node[circle, draw=black, minimum size=2.5cm] (T) at (3.398075, -1.5) {Testing};
