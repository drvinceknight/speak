...
\begin{document}
    ...
    \begin{frame}
        \centering
        \includegraphics[width=.8\textwidth]{static/screenshots/cfm.png}
    \end{frame}
    ...
    \begin{frame}
        \centering
        \includegraphics[width=.8\textwidth]{static/screenshots/oop.png}
    \end{frame}

    \begin{frame}
        \frametitle{PhD level resource practice workshop}
        \centering
    ...
    \begin{frame}
        \centering
        \includegraphics[width=.8\textwidth]{static/screenshots/rsd.png}
    \end{frame}
