...
\title{Measuring the Price of Anarchy in Critical Care Units}
...
{\backgroundimage{.3}{img/cone_in_water.jpg}
    \frame{\titlepage}
}
...
\frame{
    \begin{columns}
        ...
        \end{itemize}
        \column{.5\textwidth}
        \includegraphics[width=5cm]{./img/PigousExample.pdf}
...
\frame{
    \begin{center}
        {\Large
        Game Theory and Healthcare
        }
    \end{center}
}

{\backgroundimage{1}{img/PoA_Healthcare.pdf}
    \frame{
    \pause
    \begin{block}{}
        \textbf{Selfish Routing in Public Services} in \textit{European Journal of
        Operational Research.} \emph{2013}
    \end{block}
    }
}

{\backgroundimage{.3}{img/ambulances.jpg}
\frame{
    \begin{center}
...
{\backgroundimage{1}{img/RG_state_dependent_model.jpg}
\frame{
    \pause
    \begin{block}{}
    \textbf{Mathematical modelling of patient flows to predict critical care
    capacity required following the merger of two District General Hospitals
    into one.}, \textit{Anaesthesia}
    \end{block}
}
}
...
$$
\begin{array}{cc}
\includegraphics[width=.3\textwidth]{./img/NH.pdf}&\includegraphics[width=.3\textwidth]{./img/RG.pdf}\\
h=NH&h=RG
\end{array}
$$
$(K_{\NH}, K_{\RG})=(1,12)$:
$$
\begin{array}{cc}
\includegraphics[width=.3\textwidth]{./img/NH_1_12.pdf}&\includegraphics[width=.3\textwidth]{./img/RG_1_12.pdf}\\
h=\NH&h=\RG
\end{array}
$$
...
\frame{
$$\begin{array}{cc}
\includegraphics[width=.5\textwidth]{./img/best_responses_ex_for_proof_NH.pdf}&
\includegraphics[width=.5\textwidth]{./img/best_responses_ex_for_proof_RG.pdf}
\end{array}$$
}
...
{\backgroundimage{1}{./img/proof.pdf}
\frame{}
}
...
$$
\begin{array}{cc}
\includegraphics[width=.5\textwidth]{./img/best_responses_model1.pdf}&
\includegraphics[width=.5\textwidth]{./img/best_responses_model1_t=0_6.pdf}\\
\text{($t=0.8$)}&\text{($t=0.6$)}
\end{array}
$$
}
...
{
\backgroundimage{1}{./img/model2targetvdemand.pdf}
\frame{}
}

{
\backgroundimage{1}{./img/argminPoAmodel2.pdf}
\frame{}
}
...
\begin{block}{}
    \textbf{Measuring the Price of Anarchy in Critical Care Unit Interactions},
\textit{Minor revisions to Journal of Operational Research}
\end{block}
}

{
\backgroundimage{.3}{img/borthchristmas.jpeg}
\frame{
\begin{center}
\href{https://twitter.com/drvinceknight}{@drvinceknight}\\
knightva@cardiff.ac.uk\\
\framebox{\href{http://drvinceknight.github.io/Talks/}{vknight.org/Talks}}\\
\vspace{1cm}
\href{https://twitter.com/IzabelaKomenda}{@IzabelaKomenda}\\
Professor Jeff Griffiths\\
\pause
\vspace{1cm}
\framebox{\href{https://github.com/Axelrod-Python/Axelrod}{github.com/Axelrod-Python/Axelrod}}\\
\end{center}
}
}
